...
var (
	...
	JavaAsyncProfilerDenylist    = kingpin.Flag("java-async-profiler-denylist", "Skip Java async profiling for containers matching this regex").Envar("JAVA_ASYNC_PROFILER_DENYLIST").String()
